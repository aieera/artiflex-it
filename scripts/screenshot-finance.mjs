...
await page.goto("http://localhost:5178/business-solutions/finance-accounting-software", { waitUntil: "networkidle" });
await page.waitForTimeout(1200);

await page.screenshot({ path: "scripts/_screenshots/finance-hero.png", fullPage: false });
...
await page.screenshot({ path: "scripts/_screenshots/finance-stats.png" });

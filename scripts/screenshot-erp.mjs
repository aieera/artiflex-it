...
await page.goto("http://localhost:5175/business-solutions/erp-software", { waitUntil: "networkidle" });
await page.waitForTimeout(1200);

await page.screenshot({ path: "scripts/_screenshots/erp-hero.png", fullPage: false });
await page.screenshot({ path: "scripts/_screenshots/erp-full.png", fullPage: true });
...
// scroll + stats/comparison shots
await page.evaluate(() => window.scrollTo(0, window.innerHeight * 0.85));
await page.waitForTimeout(600);
await page.screenshot({ path: "scripts/_screenshots/erp-stats.png" });

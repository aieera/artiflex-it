...
await page.goto("http://localhost:5177/business-solutions/sales-management-software", { waitUntil: "networkidle" });
await page.waitForTimeout(1200);

await page.screenshot({ path: "scripts/_screenshots/sales-hero.png", fullPage: false });
...
await page.screenshot({ path: "scripts/_screenshots/sales-pipeline.png" });

// scroll to field sales
await page.evaluate(() => window.scrollTo(0, document.body.scrollHeight * 0.55));
await page.waitForTimeout(600);
await page.screenshot({ path: "scripts/_screenshots/sales-field.png" });

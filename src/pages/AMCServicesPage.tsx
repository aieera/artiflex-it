...
export default function AMCServicesPage() {
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 max-w-5xl mx-auto">
            {costProblem.stats.map((stat) => (
              ...
              >
                <span className="font-display text-2xl font-bold text-red-400 sm:text-3xl">{stat.value}</span>
      ...
      <section className="relative py-16 bg-navy sm:py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <SectionHeader label="How It Works" title="AMC Onboarding Process" centered />
      ...
      <CTASection
        ...
        primaryButton={{ text: "Request AMC Quote", action: "modal" }}

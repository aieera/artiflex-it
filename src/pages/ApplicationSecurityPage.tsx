    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 max-w-5xl mx-auto">
            {appThreats.map((threat) => (
              <div
                key={threat.label}
                className="group relative rounded-2xl border border-red-500/20 bg-gradient-to-br from-red-950/20 to-navy-deep p-5 sm:p-6 transition-all duration-300 hover:border-red-500/40 hover:shadow-lg hover:shadow-red-500/5"
              >
                <div className="mb-3 sm:mb-4">
                  <span className="font-display text-2xl font-bold text-red-400 sm:text-3xl">
                    {threat.stat}
                  </span>
                  <span className="ml-3 text-sm font-semibold uppercase tracking-widest text-red-400/70">
                    {threat.label}
                  </span>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
            {complianceMapping.map((item) => (
              <div
                key={item.framework}
                className="rounded-2xl border border-white/[0.06] bg-gradient-to-br from-navy-light/40 to-navy-deep/60 p-5 transition-all duration-300 hover:border-brand-cyan/20"
              >
                <h3 className="font-display text-lg font-bold text-amber-400 mb-2">{item.framework}</h3>
                <p className="text-sm text-slate-400 leading-relaxed">{item.requirement}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-16 bg-navy sm:py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <SectionHeader
            label="Our Process"
            title="How We Secure Your Applications"
            centered
          />
          <ProcessFlow steps={methodologySteps} />
        </div>
      </section>

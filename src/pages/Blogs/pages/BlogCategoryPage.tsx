/**
 * BlogCategoryPage, `/blog/category/:tag`
 *
 * Topic landing page that lists every post tagged with the given category,
 * using the same two-column layout as the blog index: a featured card, a
 * paginated article list, and a sidebar (search, Recent/Archives/Tags,
 * follow links, categories, newsletter). Search and the Archives month
 * picker filter within the category. Unknown slugs redirect to /blog.
 */
...
import { posts, allTags, type BlogTag } from "@/content/blog/posts";
...
/* ───────── per-category metadata (SEO + page copy) ───────── */
...
type CategoryMeta = {
  ...
  topics: string[]; // shown as keyword pills under the hero
};

const CATEGORY_META: Record<BlogTag, CategoryMeta> = {
  cybersecurity: {
    label: "Cybersecurity",
    shortLabel: "Cybersecurity",
    metaTitle: "Cybersecurity Blog UAE | Threat Insights | Artiflex IT",
    metaDescription:
      "Cybersecurity insights for UAE businesses, ransomware, NESA, PDPL, EDR, SASE, social engineering. Field-tested analysis from Artiflex IT.",
    heroTitle: "Cybersecurity insights for UAE businesses",
    heroDescription:
      "Practical cybersecurity guidance from Artiflex IT engineers, threat-landscape analysis, defence-in-depth strategy, and compliance practice tailored to UAE, Oman, and Saudi Arabia.",
    topics: [
      "Ransomware",
      "NESA",
      "UAE PDPL",
  ...
  cloud: {
    label: "Cloud",
    shortLabel: "Cloud",
    metaTitle: "Cloud Computing Blog UAE | AWS & Azure | Artiflex IT",
    metaDescription:
      "Cloud architecture, migration, and FinOps insights for UAE businesses, AWS, Azure, and private cloud strategy from Artiflex IT engineers.",
    heroTitle: "Cloud architecture and migration insights",
    heroDescription:
      "Real-world cloud guidance from Artiflex IT, strategy, migration patterns, multi-cloud architecture, FinOps, and governance practice for UAE businesses.",
    topics: [
      "Cloud migration",
      "AWS",
      "Azure",
  ...
  compliance: {
    ...
    metaTitle: "IT Compliance Blog UAE | NESA & PDPL | Artiflex IT",
    metaDescription:
      "Practical compliance guidance for UAE businesses, NESA, UAE PDPL, ISO 27001, NIST CSF 2.0. From Artiflex IT's security advisory practice.",
    heroTitle: "Compliance practice for UAE businesses",
    heroDescription:
      "NESA, UAE PDPL, ISO 27001, and NIST CSF 2.0, implementation guides, gap-assessment frameworks, and audit-ready evidence patterns from our security advisory practice.",
    topics: [
      "NESA",
      "UAE PDPL",
      "ISO 27001",
  ...
  infrastructure: {
    ...
    metaTitle: "IT Infrastructure Blog UAE | Network & Servers | Artiflex",
    metaDescription:
      "IT infrastructure insights for UAE businesses, network design, servers, virtualization, downtime cost analysis. From Artiflex IT engineers.",
    heroTitle: "IT infrastructure insights",
    heroDescription:
      "Field-tested guidance on network architecture, servers, storage, virtualization, and the cost of downtime, written for UAE businesses making real infrastructure decisions.",
    topics: [
      "Network design",
      "Servers",
      "Virtualization",
  ...
  "managed-services": {
    ...
    shortLabel: "Managed",
    metaTitle: "Managed IT Services Blog UAE | AMC Insights | Artiflex IT",
    metaDescription:
      "Managed IT services and AMC insights for UAE businesses, cost analysis, build-vs-buy, monitoring strategy. From Artiflex IT.",
    heroTitle: "Managed IT services & AMC insights",
    heroDescription:
      "Honest economics of managed IT in the UAE, build-vs-buy analysis, AMC value, 24/7 monitoring strategy, and operational maturity benchmarks.",
    topics: [
      "AMC",
      "Build vs buy",
      "24/7 monitoring",
...
const isValidTag = (s: string | undefined): s is BlogTag =>
  s === "cybersecurity" ||
  s === "cloud" ||
  s === "compliance" ||
  s === "infrastructure" ||
...
export default function BlogCategoryPage() {
  ...
  /* ── List state (hooks must run before the early return) ── */
  const PER_PAGE = 6;
  ...
  }, [categoryPosts, query, month]);

  const featured = categoryPosts[0];
  const isFiltering = query.trim() !== "" || month !== null;
  const listSource = isFiltering ? filtered : categoryPosts.slice(1);
  ...
  const recent = useMemo(() => categoryPosts.slice(0, 5), [categoryPosts]);
  ...
  if (!isValidTag(tag)) return <Navigate to="/blog" replace />;

  const meta = CATEGORY_META[tag];
  const url = `${SITE}/blog/category/${tag}`;
  ...
  return (
    <>
      <>
        ...
        {/* JSON-LD: CollectionPage describing the category */}
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            url,
            inLanguage: "en-AE",
            isPartOf: { "@type": "Blog", name: "Artiflex IT Blog", url: `${SITE}/blog` },
            about: meta.label,
          })}
        </script>

        {/* JSON-LD: ItemList of posts in this category */}
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ItemList",
      ...
      <PageHero
        ...
        breadcrumbs={[
          ...
          { label: meta.label, href: `/blog/category/${tag}` },
        ]}
          ...
          <div className="shell">
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
              ...
              {meta.topics.map((t) => (
                <span
                  key={t}
                  className="rounded-full border border-border-light bg-surface-secondary px-3 py-1 text-xs font-medium text-body"
                >
                  {t}
                </span>
              ))}
      ...
      {categoryPosts.length === 0 ? (
        <section className="relative bg-surface-secondary py-14 sm:py-20">
          <div className="shell">
            <div className="mx-auto max-w-md py-12 text-center">
              <p className="font-display text-xl font-semibold text-heading">
                No posts in {meta.label} yet.
              </p>
              <p className="mt-3 text-sm text-body">
                We're publishing new analysis regularly, check back soon, or browse{" "}
                <Link to="/blog" className="font-semibold text-brand-blue hover:text-brand-blue-bright">
        ...
        <>
          ...
          {featured && !isFiltering && (
            <section className="relative bg-white pb-4 pt-2 sm:pb-6">
              <div className="shell">
          ...
          <section
            id="all-articles"
            className="relative scroll-mt-24 bg-surface-secondary py-14 sm:py-20"
          >
            <div className="shell">
                ...
                <div className="min-w-0">
                  <div className="mb-8 flex flex-wrap items-baseline justify-between gap-3">
                    <h2 className="font-display text-xl font-bold text-heading sm:text-2xl">
                      {filtered.length || categoryPosts.length}{" "}
                      {(filtered.length || categoryPosts.length) === 1 ? "article" : "articles"} in{" "}
                      <span className="text-brand-blue">{meta.label}</span>
                      {month && <span className="text-muted"> · {fmtMonth(month)}</span>}
                    </h2>
                    <Link to="/blog" className="text-sm font-semibold text-brand-blue hover:text-brand-blue-bright">
                      ← All articles
                    </Link>
                  </div>
                      ...
                      {pageItems.map((post) => (
                        ...
                        >
                          ...
                          <div className="min-w-0 flex-1">
                            <h3 className="font-display text-xl font-bold leading-snug text-heading transition-colors group-hover:text-brand-blue sm:text-2xl">
                ...
                <aside className="space-y-8 lg:sticky lg:top-24 lg:self-start">
                  ...
                  <div className="relative">
                    <input
                      ...
                      aria-label={`Search ${meta.label} articles`}
                        ...
                        {tags.map((t) => (
                          <Link
                            ...
                            className={`rounded-full border px-3 py-1 text-xs font-medium transition-colors ${
                              t.tag === tag
                                ? "border-brand-blue bg-brand-blue text-white"
                                : "border-border-light bg-surface-secondary text-body hover:border-brand-blue/40 hover:bg-brand-blue/5 hover:text-brand-blue"
                            }`}
                          >
                            {t.label} ({t.count})
                          </Link>
                          ...
                          <Link
                            ...
                            className={`flex items-center justify-between py-2.5 text-sm transition-colors ${
                              t.tag === tag
                                ...
                                : "text-body hover:text-brand-blue"
                            }`}
                          >
      ...
      <CTASection
        title={`Need help with ${meta.label.toLowerCase()}?`}

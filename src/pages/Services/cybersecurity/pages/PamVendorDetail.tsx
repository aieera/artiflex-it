...
import { pamVendors } from "../data/pamVendors";
...
export default function PamVendorDetail() {
  const { slug } = useParams<{ slug: string }>();
  const vendor = slug ? pamVendors[slug] : undefined;
  ...
  if (!vendor) {
    return <Navigate to="/cybersecurity/identity-access-security/pam" replace />;
  }
  ...
  const pageUrl = `https://artiflexit.com/cybersecurity/pam/${vendor.slug}`;
  const pageTitle = `${vendor.name} | Privileged Access Management UAE | Artiflex IT`;
  ...
  return (
    <>
      ...
      {/* JSON-LD: Product schema for the PAM platform */}
        ...
        {JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Cybersecurity", item: "https://artiflexit.com/cybersecurity" },
            {
              ...
              item: "https://artiflexit.com/cybersecurity/identity-access-security/pam",
            },
            ...
            >
              ...
              <div className="mt-10 flex flex-col gap-5">
                ...
                <div className="flex flex-wrap items-center gap-x-2 gap-y-2 sm:gap-x-3">
                  ...
                  <Link
                    to="/cybersecurity/identity-access-security/pam#vendor-matrix"
                  ...
                  <Link
                    to="/cybersecurity/identity-access-security/pam#gartner-comparison"
                    className="group inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-4 py-1.5 text-xs font-semibold text-slate-200 transition-all hover:-translate-y-0.5 hover:border-[#28B5E1]/60 hover:bg-white/10 hover:text-white sm:text-[13px]"
                  >
        ...
        <div className="shell">
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#0A3D6B] via-[#04101E] to-[#020617] p-8 shadow-xl shadow-[#1B8AC7]/10 sm:p-12">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              >
                Back to Privileged Access Management
              </Link>
            </div>
          </div>
        </div>
      ...
      <CTASection
        ...
        description="Free PAM assessment, vendor-neutral sizing, and a written recommendation. We will tell you when another vendor is the better fit."
        primaryButton={{ text: "Request the assessment", action: "modal" }}
        secondaryButton={{
          text: "Compare all vendors",
          href: "/cybersecurity/identity-access-security/pam#vendor-matrix",
        }}
      />
    </>
  );

...
import { mfaVendors } from "../data/mfaVendors";
...
export default function MfaVendorDetail() {
  const { slug } = useParams<{ slug: string }>();
  const vendor = slug ? mfaVendors[slug] : undefined;
  ...
  if (!vendor) {
    return <Navigate to="/cybersecurity/identity-access-security/mfa" replace />;
  }

  // Build a safe meta description, break on a word boundary if the source is
  // longer than the snippet limit so Google does not show a half-cut sentence.
  ...
  const pageUrl = `https://artiflexit.com/cybersecurity/mfa/${vendor.slug}`;
  const pageTitle = `${vendor.name} | Multi-Factor Authentication UAE | Artiflex IT`;
  const ogImage = "https://artiflexit.com/og/identity-access-security.png";
  ...
  return (
    <>
      ...
      {/* JSON-LD: Product schema for the MFA platform */}
        ...
        {JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Cybersecurity", item: "https://artiflexit.com/cybersecurity" },
            {
              ...
              item: "https://artiflexit.com/cybersecurity/identity-access-security/mfa",
            },
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#04101E] to-[#0A3D6B]">
        ...
        <div className="relative z-10 border-b border-white/5">
          <div className="shell flex w-full items-center gap-2 pt-24 pb-3 text-[11px] text-slate-400 sm:pt-28">
            ...
            <span className="text-slate-600">/</span>
            <Link
              to="/cybersecurity/identity-access-security/mfa"
            ...
            >
              ...
              <div className="mt-10 flex flex-col gap-5">
                ...
                <div className="flex flex-wrap items-center gap-x-2 gap-y-2 sm:gap-x-3">
                  ...
                  <Link
                    to="/cybersecurity/identity-access-security/mfa#vendor-matrix"
                  ...
                  <Link
                    to="/cybersecurity/identity-access-security/mfa#gartner-comparison"
                    className="group inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-4 py-1.5 text-xs font-semibold text-slate-200 transition-all hover:-translate-y-0.5 hover:border-[#28B5E1]/60 hover:bg-white/10 hover:text-white sm:text-[13px]"
                  >
        ...
        <div className="shell">
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#0A3D6B] via-[#04101E] to-[#020617] p-8 shadow-xl shadow-[#1B8AC7]/10 sm:p-12">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              >
                Back to Multi-Factor Authentication
              </Link>
            </div>
          </div>
        </div>
      ...
      <CTASection
        ...
        description="Free MFA assessment, vendor-neutral sizing, and a written recommendation. We will tell you when another vendor is the better fit."
        primaryButton={{ text: "Request the assessment", action: "modal" }}
        secondaryButton={{
          text: "Compare all vendors",
          href: "/cybersecurity/identity-access-security/mfa#vendor-matrix",
        }}
      />
    </>
  );

...
const stats = [
  { value: "60%", label: "BREACHES EXPLOIT KNOWN VULNS", source: "Verizon DBIR" },
  { value: "15min", label: "AVG. TIME TO EXPLOIT NEW CVE", source: "After public disclosure" },
  { value: "215 days", label: "AVG. DWELL TIME (UNDETECTED)", source: "Industry benchmark" },
  { value: "Continuous", label: "SOPHOS MANAGED RISK", source: "Always-on managed service" },
];
